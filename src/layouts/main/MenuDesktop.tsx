...
export interface IMenuDesktopItem {
  path: string;
  title: string;
  children?: Array<SubMenuProps>;
}

export interface MenuDesktopItemProps {
  isHome?: boolean;
  isOffset?: boolean;
  isOpen?: boolean;
...
function MenuDesktopItem({ item, isHome, isOpen = false, isOffset, onOpen, onClose }: MenuDesktopItemProps) {
  const { pathname } = useRouter();
