import { TransitionVariantProps, varTranEnter, varTranExit } from './transition';

// ----------------------------------------------------------------------
export interface ScaleVariantProps extends TransitionVariantProps {
  distance?: number;
}

export const varScale = (props?: ScaleVariantProps) => {
