...
export const varBgColor = (props?: BackgroundVariantProps) => {
...
export const varBgKenburns = (props?: BackgroundVariantProps) => {
  const duration = props?.duration || 5;
...
export const varBgPan = (props?: BackgroundVariantProps) => {
