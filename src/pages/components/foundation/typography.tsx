...
import { Box, Container, Grid, Typography, Stack, Paper, TypographyVariant } from '@mui/material';
// routes
...
// ----------------------------------------------------------------------
export interface DemoTypographyProps {
  label?: string;
...
FoundationTypography.getLayout = function getLayout(page: React.ReactElement) {
...
export interface BlockVariantProps {
  font: DemoTypographyProps;
}

function BlockVariant({ font }: BlockVariantProps) {
  const getValue = (variant: TypographyVariant) => getFontValue(variant);
