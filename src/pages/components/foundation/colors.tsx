...
// @mui
import { useTheme, hexToRgb, styled, Palette, PaletteColor } from '@mui/material/styles';
...
const PALETTE = ['primary', 'secondary', 'info', 'success', 'warning', 'error'] as (keyof Palette)[];
const COLORS_VARIATIONS = ['lighter', 'light', 'main', 'dark', 'darker'] as (keyof PaletteColor)[];
