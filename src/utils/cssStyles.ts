...
export interface CSStyleResult {
  bgBlur: (props?: BGProps) => any;
  bgGradient: (props?: BGProps) => any;
  bgImage: (props?: BGProps) => any;
}
export default function cssStyles(theme?: Theme): CSStyleResult {
  return {
    bgBlur: (props) => {
